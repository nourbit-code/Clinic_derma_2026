...
const InventoryReport: React.FC<InventoryReportProps> = ({ role }) => {
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            const inventoryRes = inventoryResRaw as ApiResult<BackendInventoryItem[]>;
            const lowStockRes = lowStockResRaw as ApiResult<BackendInventoryItem[]>;
            const expiringRes = expiringResRaw as ApiResult<BackendInventoryItem[]>;
            const summaryRes = summaryResRaw as ApiResult<SummaryData>;
            const transactionsRes = transactionsResRaw as ApiResult<StockTransaction[]>;

...
import { Home, Calendar, User, DollarSign, Users, LogOut, Box, ClipboardList, Settings } from "lucide-react-native";
...
export default function Sidebar() {
  ...
  const menu: MenuItem[] = [
    ...
    { label: "Settings", path: "/receptionist/settings", icon: <Settings size={24} color="#E0E0E0" /> },
